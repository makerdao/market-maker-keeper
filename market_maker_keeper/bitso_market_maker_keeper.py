...
class BitsoMarketMakerKeeper:
    ...
    def __init__(self, args: list):
        ...
        parser.add_argument("--bitso-secret-key", type=str, required=True,
                            help="Secret key for the bitso API")
    ...
    def startup(self):
        ...
        quote_increment = self.bitso_api.get_product(self.arguments.pair)["quote_increment"]
    ...
    def place_orders(self, new_orders: List[NewOrder]):
        def place_order_function(new_order_to_be_placed):
            ...
            order_id = self.bitso_api.place_order(self.pair(), new_order_to_be_placed.is_sell, price, amount)
