...
class GateIOApi:
    ...
    def pairs(self):
        URL = "/api2/1/pairs"
        params=''
        return httpGet(self.api_server, URL, params)
    ...
    def ticker(self,param):
        URL = "/api2/1/ticker"
        return httpGet(self.api_server, URL, param)
    ...
    def balances(self):
        ...
        param = {}
        return httpPost(self.api_server, URL, param, self.api_key, self.secret_key)
    ...
    def depositAddres(self,param):
        ...
        return httpPost(self.api_server, URL, params, self.api_key, self.secret_key)
